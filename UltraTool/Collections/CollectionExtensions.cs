...
public static class CollectionExtensions
{
    ...
    public static bool AddIf<T, TCollection>(this TCollection coll, T value, Predicate<T> match)
    ...
    public static bool AddIfNotContains<T, TCollection>(this TCollection coll, T value)
        where TCollection : ICollection<T>
    {
    ...
    [CollectionAccess(CollectionAccessType.UpdatedContent)]
    public static bool AddNonNull<T, TCollection>(this TCollection coll, [NotNullWhen(true)] T? value)
        where TCollection : ICollection<T>
    {
    ...
    [CollectionAccess(CollectionAccessType.ModifyExistingContent)]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool RemoveIf<T, TCollection>(this TCollection coll, T value, Predicate<T> match)
        where TCollection : ICollection<T> => match.Invoke(value) && coll.Remove(value);
